...
export class RefComponent implements OnInit {
  ...
  constructor(private refService:RefService,private matchService:MatchService,private tokenStorageService:TokenStorageService,private router: Router) { }
