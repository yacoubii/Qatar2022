...
public class SpectatorController {
    ...
    @PostMapping
    public void registerNewSpectator(@Valid @RequestBody Spectator spectator, BindingResult bindingResult){
        spectatorService.addNewSpectator(spectator,bindingResult);
    }
